<template>
  <div>
    ...
    <ConfirmModal :open="!!pendingDelete" title="Delete this madhhab?" message="Scholars using it will keep their other data; the tag will be removed." @cancel="pendingDelete = null" @confirm="destroy" />
  </div>
</template>
